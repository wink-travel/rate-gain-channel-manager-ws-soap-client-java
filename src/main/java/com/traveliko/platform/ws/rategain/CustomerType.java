...
@XmlSeeAlso({
    com.traveliko.platform.ws.rategain.CustomerPrimaryAdditionalType.Primary.class,
    com.traveliko.platform.ws.rategain.CustomerPrimaryAdditionalType.Additional.class
})
