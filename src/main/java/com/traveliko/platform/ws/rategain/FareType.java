...
@XmlSeeAlso({
    com.traveliko.platform.ws.rategain.PTCFareBreakdownType.PassengerFare.class,
    com.traveliko.platform.ws.rategain.AirItineraryPricingInfoType.ItinTotalFare.class
})
