...
@XmlSeeAlso({
    com.traveliko.platform.ws.rategain.VehicleReservationRQAdditionalInfoType.RentalPaymentPref.class,
    com.traveliko.platform.ws.rategain.FulfillmentType.PaymentDetails.PaymentDetail.class
})
