...
@XmlSeeAlso({
    com.traveliko.platform.ws.rategain.PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg.class,
    com.traveliko.platform.ws.rategain.OriginDestinationOptionType.FlightSegment.class
})
