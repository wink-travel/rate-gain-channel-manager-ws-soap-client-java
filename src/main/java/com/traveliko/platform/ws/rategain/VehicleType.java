...
@XmlSeeAlso({
    com.traveliko.platform.ws.rategain.VehicleLocationLiabilitiesType.Coverages.Coverage.CoverageFees.CoverageFee.Vehicles.Vehicle.class,
    com.traveliko.platform.ws.rategain.VehicleLocationVehiclesType.Vehicle.class,
    com.traveliko.platform.ws.rategain.VehicleRentalTransactionType.Vehicle.class
})
