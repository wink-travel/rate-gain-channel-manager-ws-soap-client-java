...
@XmlSeeAlso({
    com.traveliko.platform.ws.rategain.HotelRoomListType.Guests.Guest.class,
    com.traveliko.platform.ws.rategain.HotelRoomListType.MasterContact.class,
    com.traveliko.platform.ws.rategain.RecipientInfosType.RecipientInfo.class
})
