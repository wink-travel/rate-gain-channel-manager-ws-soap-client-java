...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.CustomerPrimaryAdditionalType.Primary.class,
    com.traveliko.ws.platform.rategain.CustomerPrimaryAdditionalType.Additional.class
})
