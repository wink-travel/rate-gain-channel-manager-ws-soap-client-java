...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.CompanyInfoType.AddressInfo.class,
    com.traveliko.ws.platform.rategain.RequiredPaymentsType.GuaranteePayment.Address.class,
    com.traveliko.ws.platform.rategain.CustomerType.Address.class,
    com.traveliko.ws.platform.rategain.AddressesType.Address.class
})
