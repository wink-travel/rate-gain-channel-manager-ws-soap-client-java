...
@XmlSeeAlso({
    ...
    com.traveliko.ws.platform.rategain.AllianceConsortiumType.AllianceMember.class,
    com.traveliko.ws.platform.rategain.DirectBillType.CompanyName.class,
    com.traveliko.ws.platform.rategain.VehicleAvailCoreType.Vendor.class,
    CompanyNamePrefType.class,
    TravelArrangerType.class,
    com.traveliko.ws.platform.rategain.FlightSegmentType.MarketingAirline.class
})
