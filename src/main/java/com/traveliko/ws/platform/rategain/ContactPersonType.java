...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.HotelRoomListType.Guests.Guest.class,
    com.traveliko.ws.platform.rategain.HotelRoomListType.MasterContact.class,
    com.traveliko.ws.platform.rategain.RecipientInfosType.RecipientInfo.class
})
