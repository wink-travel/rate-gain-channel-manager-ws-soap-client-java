...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.VerificationType.PersonName.class,
    com.traveliko.ws.platform.rategain.TravelClubType.ClubMemberName.class,
    com.traveliko.ws.platform.rategain.DonationType.DonorInfo.Name.class,
    com.traveliko.ws.platform.rategain.OrganizationType.OrgMemberName.class
})
