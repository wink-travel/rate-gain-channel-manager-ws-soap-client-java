...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.CompanyInfoType.Email.class,
    com.traveliko.ws.platform.rategain.CustomerType.Email.class,
    com.traveliko.ws.platform.rategain.AirTravelerType.Email.class
})
