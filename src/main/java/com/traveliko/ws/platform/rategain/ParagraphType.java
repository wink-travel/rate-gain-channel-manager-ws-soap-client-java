...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.InvBlockType.BlockDescriptions.BlockDescription.class,
    com.traveliko.ws.platform.rategain.ProfileType.Comments.Comment.class,
    com.traveliko.ws.platform.rategain.SpecialRequestType.SpecialRequest.class,
    com.traveliko.ws.platform.rategain.CommentType.Comment.class
})
