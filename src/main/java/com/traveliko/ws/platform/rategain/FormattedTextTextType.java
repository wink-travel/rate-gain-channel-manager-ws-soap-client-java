...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.FulfillmentType.PaymentText.class,
    com.traveliko.ws.platform.rategain.VehicleRentalDetailsType.ConditionReport.class,
    com.traveliko.ws.platform.rategain.ImageDescriptionType.Description.class,
    com.traveliko.ws.platform.rategain.TextDescriptionType.Description.class,
    com.traveliko.ws.platform.rategain.RateQualifierType.RateComments.RateComment.class,
    com.traveliko.ws.platform.rategain.ParagraphType.ListItem.class,
    CoverageDetailsType.class,
    com.traveliko.ws.platform.rategain.TravelerInfoType.AirTraveler.Comment.class
})
