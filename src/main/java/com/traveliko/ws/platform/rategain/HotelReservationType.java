...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.HotelReservationsType.HotelReservation.class,
    com.traveliko.ws.platform.rategain.HotelResModifyType.HotelResModify.class
})
