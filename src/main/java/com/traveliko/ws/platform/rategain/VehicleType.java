...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.VehicleLocationLiabilitiesType.Coverages.Coverage.CoverageFees.CoverageFee.Vehicles.Vehicle.class,
    com.traveliko.ws.platform.rategain.VehicleLocationVehiclesType.Vehicle.class,
    com.traveliko.ws.platform.rategain.VehicleRentalTransactionType.Vehicle.class
})
