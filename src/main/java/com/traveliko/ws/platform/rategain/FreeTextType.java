...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.PTCFareBreakdownType.Endorsements.Endorsement.class,
    CertificationType.class,
    ErrorType.class,
    WarningType.class,
    com.traveliko.ws.platform.rategain.TicketingInfoType.TicketAdvisory.class,
