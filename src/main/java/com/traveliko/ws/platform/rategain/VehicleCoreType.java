...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.VehicleAgeRequirementsType.Age.Vehicles.Vehicle.class,
    VehiclePrefType.class,
    VehicleType.class,
    com.traveliko.ws.platform.rategain.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.Vehicles.Vehicle.class
})
