...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.CompanyInfoType.PaymentForm.class,
    com.traveliko.ws.platform.rategain.GuaranteeType.GuaranteesAccepted.GuaranteeAccepted.class,
    HotelPaymentFormType.class,
    com.traveliko.ws.platform.rategain.CustomerType.PaymentForm.class,
