...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg.class,
    com.traveliko.ws.platform.rategain.OriginDestinationOptionType.FlightSegment.class
})
