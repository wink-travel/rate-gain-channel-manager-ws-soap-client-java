...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.DonationType.DonorInfo.ContactInfo.class,
    com.traveliko.ws.platform.rategain.OffLocationServiceCoreType.Address.class,
    com.traveliko.ws.platform.rategain.ItemSearchCriterionType.Address.class,
    AddressInfoType.class,
    com.traveliko.ws.platform.rategain.AirTravelerType.Address.class
})
