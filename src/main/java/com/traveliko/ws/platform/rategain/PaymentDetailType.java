...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.VehicleReservationRQAdditionalInfoType.RentalPaymentPref.class,
    com.traveliko.ws.platform.rategain.FulfillmentType.PaymentDetails.PaymentDetail.class
})
