...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.PTCFareBreakdownType.FareInfo.class,
    com.traveliko.ws.platform.rategain.AirItineraryPricingInfoType.FareInfos.FareInfo.class
})
