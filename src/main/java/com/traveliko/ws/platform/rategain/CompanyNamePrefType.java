...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.AirSearchPrefsType.VendorPref.class,
    com.traveliko.ws.platform.rategain.VehicleAvailRQCoreType.VendorPrefs.VendorPref.class,
    com.traveliko.ws.platform.rategain.AirlinePrefType.VendorPref.class
})
