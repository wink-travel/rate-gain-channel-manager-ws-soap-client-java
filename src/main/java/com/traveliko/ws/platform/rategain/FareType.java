...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.PTCFareBreakdownType.PassengerFare.class,
    com.traveliko.ws.platform.rategain.AirItineraryPricingInfoType.ItinTotalFare.class
})
