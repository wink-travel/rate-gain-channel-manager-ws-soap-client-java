...
@XmlSeeAlso({
    com.traveliko.ws.platform.rategain.VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo.class,
    VendorMessageType.class,
    VehicleLocationInformationType.class,
    com.traveliko.ws.platform.rategain.VehicleLocationVehiclesType.VehicleInfos.VehicleInfo.class,
    com.traveliko.ws.platform.rategain.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo.class,
    com.traveliko.ws.platform.rategain.VehicleLocationAdditionalDetailsType.Shuttle.ShuttleInfos.ShuttleInfo.class
})
